...
const sourceStyles: Record<string, CSSProperties> = {
  root: { position: 'absolute', inset: 0, zIndex: 30, minHeight: 0, display: 'flex', flexDirection: 'column', color: inkTheme.text, background: inkTheme.canvas, fontFamily: inkTypography.sans },
  toolbar: { minHeight: 48, display: 'flex', alignItems: 'center', gap: 7, padding: '0 12px', borderBottom: `1px solid ${inkTheme.line}`, background: inkTheme.surfaceRaised },
  brand: { minWidth: 190, marginRight: 'auto', display: 'grid', gap: 2, fontFamily: inkTypography.serif, fontSize: 13, letterSpacing: '.03em' },
  toolbarButton: { height: 31, padding: '0 10px', border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer', fontSize: 11 },
  toolbarButtonActive: { color: '#fff', borderColor: inkTheme.inkFill, background: inkTheme.inkFill, fontWeight: 800 },
  saveButton: { height: 32, padding: '0 12px', border: `1px solid ${inkTheme.inkFill}`, borderRadius: 5, color: '#fff', background: inkTheme.inkFill, cursor: 'pointer', fontWeight: 800, fontSize: 11 },
  disabled: { opacity: .45, cursor: 'not-allowed' },
  closeButton: { width: 32, height: 32, border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 5, color: inkTheme.cinnabar, background: inkTheme.cinnabarSoft, cursor: 'pointer', fontSize: 20 },
  body: { flex: 1, minHeight: 0, display: 'grid', overflow: 'hidden', transition: 'grid-template-columns .18s ease' },
  treePane: { minWidth: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', borderRight: `1px solid ${inkTheme.line}`, background: inkTheme.surfaceSoft },
  treeActions: { width: 190, display: 'flex', gap: 5, padding: 8, boxSizing: 'border-box', borderBottom: `1px solid ${inkTheme.line}` },
  treeScroller: { width: 190, flex: 1, minHeight: 0, overflowY: 'auto', padding: '6px 5px', boxSizing: 'border-box' },
  treeItem: { width: '100%', height: 27, display: 'flex', alignItems: 'center', gap: 5, border: 0, borderRadius: 4, color: inkTheme.textSoft, background: 'transparent', cursor: 'pointer', textAlign: 'left', fontSize: 11 },
  treeItemActive: { color: inkTheme.text, background: inkTheme.accentSoft, boxShadow: `inset 3px 0 0 ${inkTheme.cinnabar}` },
  treeIcon: { width: 13, color: inkTheme.accentHover },
  treeName: { minWidth: 0, flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  lock: { color: inkTheme.warning, fontSize: 6 },
  fileActions: { width: 190, display: 'flex', gap: 5, padding: 8, boxSizing: 'border-box', borderTop: `1px solid ${inkTheme.line}` },
  tinyButton: { minHeight: 26, padding: '0 7px', border: `1px solid ${inkTheme.line}`, borderRadius: 4, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer', fontSize: 10 },
  dangerTinyButton: { minHeight: 26, padding: '0 7px', border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 4, color: inkTheme.cinnabar, background: inkTheme.cinnabarSoft, cursor: 'pointer', fontSize: 10 },
  main: { minWidth: 0, minHeight: 0, display: 'grid', overflow: 'hidden' },
  editorPane: { minWidth: 0, minHeight: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', background: inkTheme.surface },
  tabs: { minHeight: 33, display: 'flex', overflowX: 'auto', borderBottom: `1px solid ${inkTheme.line}`, background: inkTheme.surfaceSoft },
  tab: { flex: 'none', height: 33, display: 'flex', alignItems: 'center', gap: 7, padding: '0 9px', borderTop: '2px solid transparent', borderRight: `1px solid ${inkTheme.line}`, borderBottom: 0, borderLeft: 0, color: inkTheme.muted, background: 'transparent', cursor: 'pointer', fontSize: 10 },
  tabActive: { color: inkTheme.text, borderTop: `2px solid ${inkTheme.cinnabar}`, background: inkTheme.surface },
  tabClose: { color: inkTheme.muted, fontSize: 14 },
  editorBody: { flex: 1, minHeight: 0, overflow: 'hidden' },
  codeEditor: { width: '100%', height: '100%', overflow: 'hidden' },
  noFile: { height: '100%', display: 'grid', placeItems: 'center', color: inkTheme.muted, fontSize: 12 },
  imagePreview: { width: '100%', height: '100%', display: 'grid', placeItems: 'center', overflow: 'auto', padding: 20, boxSizing: 'border-box', background: inkTheme.canvasDeep },
  imagePreviewContent: { maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', borderRadius: 5, boxShadow: inkTheme.shadowSoft },
  binaryInfo: { height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 20, color: inkTheme.muted, textAlign: 'center', fontSize: 12 },
  editorStatus: { minHeight: 28, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, padding: '0 9px', borderTop: `1px solid ${inkTheme.line}`, color: inkTheme.muted, background: inkTheme.surfaceSoft, fontSize: 10 },
  statusActions: { display: 'flex', alignItems: 'center', gap: 8 },
  statusButton: { padding: '3px 7px', border: `1px solid ${inkTheme.line}`, borderRadius: 4, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer', fontSize: 10 },
  divider: { display: 'grid', placeItems: 'center', overflow: 'hidden', color: inkTheme.muted, background: inkTheme.line, cursor: 'col-resize', userSelect: 'none' },
  previewPane: { minWidth: 0, minHeight: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', background: inkTheme.canvasDeep },
  previewHeader: { height: 33, flex: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 9px', color: '#fff', background: inkTheme.inkFill, fontSize: 11 },
  previewActions: { display: 'flex', alignItems: 'center', gap: 5 },
  textModeButtonActive: { color: inkTheme.text, borderColor: inkTheme.lineStrong, background: inkTheme.accentSoft, fontWeight: 800 },
  areaModeButtonActive: { color: inkTheme.text, borderColor: inkTheme.area, background: inkTheme.areaSoft, fontWeight: 800 },
  previewFrame: { flex: 1, width: '100%', minHeight: 0, border: 0, background: '#fff' },
  emptyPreview: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, color: inkTheme.muted, textAlign: 'center' },
  textEditPanel: { flex: 'none', display: 'grid', gap: 8, padding: 10, borderTop: `1px solid ${inkTheme.line}`, color: inkTheme.text, background: inkTheme.surfaceSoft },
  textEditHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, fontSize: 11 },
  textEditInput: { width: '100%', minHeight: 72, resize: 'vertical', boxSizing: 'border-box', padding: 9, border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.text, background: inkTheme.surface, font: `12px/1.5 ${inkTypography.sans}` },
  textEditActions: { display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 7, color: inkTheme.muted, fontSize: 10 },
  secondaryTextButton: { height: 29, padding: '0 9px', border: `1px solid ${inkTheme.line}`, borderRadius: 4, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer', fontSize: 10 },
  primaryButton: { height: 34, padding: '0 13px', border: `1px solid ${inkTheme.inkFill}`, borderRadius: 5, color: '#fff', background: inkTheme.inkFill, cursor: 'pointer', fontWeight: 800 },
  secondaryButton: { height: 34, padding: '0 13px', border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer' },
  dangerButton: { height: 34, padding: '0 13px', border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 5, color: inkTheme.cinnabar, background: inkTheme.cinnabarSoft, cursor: 'pointer', fontWeight: 800 },
  historyPanel: { position: 'absolute', right: 16, top: 60, zIndex: 35, width: 330, maxHeight: 420, overflowY: 'auto', padding: 10, border: `1px solid ${inkTheme.lineStrong}`, borderRadius: 7, background: inkTheme.surface, boxShadow: inkTheme.shadow },
  historyHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3px 3px 9px' },
  historyItem: { width: '100%', display: 'grid', gridTemplateColumns: '1fr auto auto', gap: 8, padding: '8px 7px', border: 0, borderTop: `1px solid ${inkTheme.line}`, color: inkTheme.textSoft, background: 'transparent', cursor: 'pointer', textAlign: 'left', fontSize: 10 },
  conflictOverlay: { position: 'absolute', inset: 0, zIndex: 50, display: 'grid', placeItems: 'center', padding: 24, background: inkTheme.overlayStrong, backdropFilter: 'blur(5px)' },
  conflictDialog: { width: 'min(900px, 96vw)', maxHeight: '86vh', overflowY: 'auto', padding: 20, border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 9, color: inkTheme.text, background: inkTheme.surface, boxShadow: inkTheme.shadow },
  folderDialog: { width: 'min(560px, 92vw)', maxHeight: '78vh', display: 'flex', flexDirection: 'column', gap: 12, padding: 20, border: `1px solid ${inkTheme.lineStrong}`, borderRadius: 9, color: inkTheme.text, background: inkTheme.surface, boxShadow: inkTheme.shadow },
  folderPath: { padding: 9, border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surfaceSoft, overflowWrap: 'anywhere', fontSize: 11 },
  folderList: { minHeight: 160, maxHeight: 420, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 3 },
  folderItem: { minHeight: 32, padding: '0 10px', border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surfaceSoft, cursor: 'pointer', textAlign: 'left' },
  conflictTitle: { display: 'block', color: inkTheme.cinnabar, fontFamily: inkTypography.serif, fontSize: 18 },
  conflictText: { color: inkTheme.textSoft, fontSize: 12, lineHeight: 1.6 },
