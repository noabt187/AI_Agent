...
const assetStyles: Record<string, CSSProperties> = {
  overlay: { position: 'absolute', inset: 0, zIndex: 50, display: 'grid', placeItems: 'center', padding: 24, background: inkTheme.overlayStrong, backdropFilter: 'blur(6px)' },
  dialog: { width: 'min(1120px, 96vw)', maxHeight: 'min(780px, 92vh)', display: 'flex', flexDirection: 'column', overflow: 'hidden', color: inkTheme.text, background: inkTheme.canvas, border: `1px solid ${inkTheme.lineStrong}`, borderTop: `3px solid ${inkTheme.accent}`, borderRadius: 10, boxShadow: inkTheme.shadow },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 18, padding: '18px 20px', borderBottom: `1px solid ${inkTheme.line}`, background: inkTheme.surfaceRaised },
  title: { display: 'block', fontFamily: inkTypography.serif, fontSize: 20, fontWeight: 600, letterSpacing: '.04em' },
  subtitle: { display: 'block', marginTop: 4, color: inkTheme.muted, fontSize: 12 },
  headerActions: { display: 'flex', alignItems: 'center', gap: 8 },
  primaryButton: { minHeight: 36, padding: '0 14px', border: `1px solid ${inkTheme.inkFill}`, borderRadius: 5, color: '#fff', background: inkTheme.inkFill, cursor: 'pointer', fontWeight: 800 },
  secondaryButton: { minHeight: 36, padding: '0 13px', border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer' },
  dangerButton: { minHeight: 34, padding: '0 12px', border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 5, color: inkTheme.cinnabar, background: inkTheme.cinnabarSoft, cursor: 'pointer', fontWeight: 700 },
  closeButton: { width: 36, height: 36, border: `1px solid ${inkTheme.line}`, borderRadius: 5, color: inkTheme.textSoft, background: inkTheme.surface, cursor: 'pointer', fontSize: 22 },
  slotBanner: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, padding: '12px 20px', color: inkTheme.text, background: inkTheme.accentSoft, borderBottom: `1px solid ${inkTheme.line}` },
  libraryBanner: { padding: '11px 20px', color: inkTheme.textSoft, background: inkTheme.surfaceSoft, borderBottom: `1px solid ${inkTheme.line}`, fontSize: 12 },
  usedPill: { padding: '4px 8px', borderRadius: 4, color: '#fff', background: inkTheme.inkFill, fontSize: 11, fontWeight: 800 },
  emptyPill: { padding: '4px 8px', borderRadius: 4, color: inkTheme.warning, background: inkTheme.warningSoft, fontSize: 11, fontWeight: 800 },
  error: { margin: '12px 20px 0', padding: '10px 12px', border: `1px solid ${inkTheme.cinnabarLine}`, borderRadius: 6, color: inkTheme.cinnabar, background: inkTheme.cinnabarSoft, fontSize: 12 },
  ...
  card: { overflow: 'hidden', border: '2px solid transparent', borderRadius: 8, background: inkTheme.surface, boxShadow: inkTheme.shadowSoft },
  cardActive: { borderColor: inkTheme.lineStrong, boxShadow: `inset 0 -3px 0 ${inkTheme.cinnabar}` },
  thumbnailButton: { width: '100%', height: 128, display: 'block', padding: 0, border: 0, background: inkTheme.surfaceMuted, cursor: 'pointer' },
  thumbnail: { width: '100%', height: '100%', display: 'block', objectFit: 'cover' },
  cardInfo: { display: 'grid', gap: 5, padding: 10, color: inkTheme.muted, fontSize: 11 },
  assetName: { overflow: 'hidden', color: inkTheme.text, textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontSize: 12 },
  cardFooter: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  deleteButton: { padding: 0, border: 0, color: inkTheme.cinnabar, background: 'transparent', cursor: 'pointer', fontSize: 11 },
  disabledButton: { opacity: .45, cursor: 'not-allowed' },
  emptyState: { minHeight: 300, width: '100%', display: 'grid', placeContent: 'center', gap: 8, border: `2px dashed ${inkTheme.lineStrong}`, borderRadius: 8, color: inkTheme.muted, background: inkTheme.surface, cursor: 'pointer', textAlign: 'center' },
  inspector: { minHeight: 0, display: 'flex', flexDirection: 'column', gap: 16, padding: 20, borderLeft: `1px solid ${inkTheme.line}`, background: inkTheme.surface },
  inspectorTitle: { fontSize: 15 },
  inspectorHelp: { color: inkTheme.muted, fontSize: 12, lineHeight: 1.6 },
  cropPreview: { aspectRatio: '16 / 9', display: 'grid', placeItems: 'center', overflow: 'hidden', border: `1px solid ${inkTheme.line}`, borderRadius: 6, color: inkTheme.muted, background: inkTheme.surfaceMuted, fontSize: 11 },
  cropPreviewImage: { width: '100%', height: '100%', display: 'block' },
  segmented: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4, padding: 4, borderRadius: 6, background: inkTheme.surfaceMuted },
  segmentButton: { height: 34, border: 0, borderRadius: 4, color: inkTheme.textSoft, background: 'transparent', cursor: 'pointer' },
  segmentActive: { color: inkTheme.text, background: inkTheme.surface, boxShadow: inkTheme.shadowSoft, fontWeight: 800 },
  rangeLabel: { display: 'grid', gap: 7, color: inkTheme.textSoft, fontSize: 12 },
